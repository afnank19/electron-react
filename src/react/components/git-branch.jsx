      ...
      <div className="flex flex-col gap-2 border-b border-neutral-800 px-2 pb-2">
        ...
        <div className="flex gap-4">
          ...
          <button
            ...
            className="flex items-center gap-1 rounded-lg border border-neutral-200 bg-neutral-100 px-2 text-xs text-neutral-800 shadow-xl hover:border-neutral-300 hover:bg-neutral-200"
          >
