    ...
    <div className="flex items-center justify-center">
      <div className="mx-2 my-8 flex w-full max-w-2xl flex-col gap-4">
        ...
        <div className="my-4 flex items-center justify-between gap-1 rounded-2xl border border-neutral-800 bg-neutral-900 p-2">
          ...
          <OpenRepo>
            <p className="flex items-center gap-2 rounded-xl border border-neutral-200 bg-neutral-100 px-2 py-1 text-sm text-neutral-800 shadow-xl hover:border-neutral-300 hover:bg-neutral-200">
              <FolderGit size={18} />
              Open Repository
            </p>
          </OpenRepo>
