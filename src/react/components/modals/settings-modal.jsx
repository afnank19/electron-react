  ...
  return (
    <div className="flex h-auto w-[40vw] flex-col gap-4 border border-neutral-800 bg-neutral-900 p-4 text-white">
      ...
      <div className="mt-2 flex justify-end gap-2">
        ...
        <button
          className="border border-neutral-200 bg-neutral-100 px-1 py-0.5 text-xs text-neutral-800 shadow-[3px_3px_0px_rgba(0,0,0,0.9)] hover:border-neutral-300 hover:bg-neutral-200"
          onClick={handleSave}
        >
          Save
        </button>
